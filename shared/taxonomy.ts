// Pure domain data shared between the frontend (src/) and backend
// (server/, api/, prisma/seed.ts) — no framework dependencies, safe to
// import from either a Vite/React build or a plain Node script.
