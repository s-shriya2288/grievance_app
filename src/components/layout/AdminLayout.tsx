            ...
            >
              {({ isActive }) => (
                <>
                  ...
                  <span className="relative z-10 flex h-7 w-7 items-center justify-center rounded-md bg-violet-100 text-sm text-violet-700 dark:bg-violet-500/20 dark:text-violet-300">
                    🏢
                  </span>
