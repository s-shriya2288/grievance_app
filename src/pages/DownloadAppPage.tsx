      ...
      <div className="flex flex-1 items-center justify-center px-4 py-10">
        ...
        >
          ...
          <div className="mt-6 flex flex-col items-center gap-2">
            <p className="text-xs text-slate-400 dark:text-slate-500">On this phone already? Scan instead:</p>
            <div className="flex w-fit items-center justify-center rounded-xl border border-slate-200 bg-white p-2 dark:border-slate-700">
              <QRCodeSVG value={apkUrl} size={96} />
            </div>
          </div>
